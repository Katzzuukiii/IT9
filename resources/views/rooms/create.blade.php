    ...
    <div class="card bg-white rounded-lg p-8">
        <form action="{{ route('rooms.store') }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="type"
                        ...
                        <option value="General Ward" {{ old('type') === 'General Ward' ? 'selected' : '' }}>General Ward</option>
                    </select>
                </div>
            ...
            <div>
                ...
                <p class="text-xs text-gray-600 mb-3">Enter equipment names separated by commas (e.g., Defibrillator, Monitor, Oxygen Tank)</p>
                <textarea name="equipment" rows="4" required
                          ...
                          placeholder="Equipment list...">{{ old('equipment') }}</textarea>
            ...
            <div class="flex gap-4 justify-end">
                <a href="{{ route('rooms.index') }}" class="px-6 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400">
                    Cancel
                </a>
