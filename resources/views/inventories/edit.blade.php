...
@section('page-title', 'Edit: ' . $inventory->name)
        ...
        <form action="{{ route('inventories.update', $inventory) }}" method="POST" class="space-y-6">
            ...
            <div class="grid grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="unit_price" value="{{ old('unit_price', $inventory->unit_price) }}" required step="0.01" min="0"
            ...
            <div>
                ...
                <textarea name="description" rows="4"
                          class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500">{{ old('description', $inventory->description) }}</textarea>
            </div>

            <div class="flex gap-4 justify-end">
                <a href="{{ route('inventories.show', $inventory) }}" class="px-6 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400">
                    Cancel
                </a>
